...
public class SettingsDialog extends JDialog {
    ...
    private JPanel buildPayloadsTab() {
        ...
        categoryCombo = new JComboBox<>(
            tab.getAttackDetector().getCategories().toArray(new String[0]));
    ...
    private void addCategory() {
        String name = JOptionPane.showInputDialog(this,
            "New category name:", "Add Category", JOptionPane.PLAIN_MESSAGE);
        ...
        if (tab.getAttackDetector().addCategory(name)) {
            ...
            JOptionPane.showMessageDialog(this,
                "Category already exists.", "Duplicate", JOptionPane.WARNING_MESSAGE);
        }
    }
    ...
    private void copyToClipboard() {
        String cat = selectedCategory();
        List<String> items = tab.getAttackDetector().getPayloads()
        ...
        payloadCountLabel.setText("Copied " + items.size() + " " + cat
            + " payload" + (items.size() != 1 ? "s" : "") + " to clipboard");
    }
    ...
    private void saveToFile() {
        ...
        chooser.setFileFilter(new javax.swing.filechooser.FileNameExtensionFilter(
            "Text Files", "txt"));
        chooser.setSelectedFile(new java.io.File(cat.toLowerCase().replace(" ", "_")
            + "_payloads.txt"));
