...
/**
 * Represents a single captured HTTP request/response pair with all
 * extracted metadata. Equivalent to the Python record dict.
 */
public class TrafficRecord {
    ...
    public String getNormalizedEndpoint() { return normalizedEndpoint; }
    public void setNormalizedEndpoint(String normalizedEndpoint) { this.normalizedEndpoint = normalizedEndpoint; }
    ...
    public void setParamValues(Map<String, String> paramValues) { this.paramValues = paramValues; }
    ...
    public Map<String, AttackPattern> getAttackPatterns() { return attackPatterns; }
    public void setAttackPatterns(Map<String, AttackPattern> attackPatterns) { this.attackPatterns = attackPatterns; }

    public boolean isEditedProxy() { return editedProxy; }
    public void setEditedProxy(boolean editedProxy) { this.editedProxy = editedProxy; }

    public boolean isDecoderUsed() { return decoderUsed; }
    public void setDecoderUsed(boolean decoderUsed) { this.decoderUsed = decoderUsed; }

    public HttpRequestResponse getHttpRequestResponse() { return httpRequestResponse; }
