...
/**
 * Aggregated endpoint data shown in the main table.
 * One row per unique (host, normalizedEndpoint) pair.
 */
public class EndpointRow {
    ...
    public void setStatusCodes(Map<String, Integer> statusCodes) { this.statusCodes = statusCodes; }
    ...
    public List<String> getAuthStates() { return authStates; }
    public void setAuthStates(List<String> authStates) { this.authStates = authStates; }
    ...
    public Set<ToolType> getToolFlags() { return toolFlags; }
    public void setToolFlags(Set<ToolType> toolFlags) { this.toolFlags = toolFlags; }

    public String getTestedBy() { return testedBy; }
    public void setTestedBy(String testedBy) { this.testedBy = testedBy; }

    public String getTestingDepth() { return testingDepth; }
    public void setTestingDepth(String testingDepth) { this.testingDepth = testingDepth; }

    public String getPriority() { return priority; }
    public void setPriority(String priority) { this.priority = priority; }

    public List<String> getTestsDetected() { return testsDetected; }
    public void setTestsDetected(List<String> testsDetected) { this.testsDetected = testsDetected; }
